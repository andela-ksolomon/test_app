...
class CreateTest extends React.Component {
  state = {
    ...
    videos: {
      ...
      "4 STEP SQUARE TEST": " https://www.youtube.com/watch?v=doaPhh3KJHM",
    ...
    if (valid) {
      ...
      const testkey =
        ...
        firebase
          .database()
          .ref()
          .child(`forms/${userId}/${this.props.formId}/tests`)
          .push().key;
      const postData =
        selectedCategory !== "PEQ TEST"
          ? {
              id: testkey,
      ...
      const node = `/forms/${userId}/pendingform/${this.props
        .formId}/tests/${childNode}`;
  ...
  isValid() {
    ...
    if (this.state.selectedCategory === "PEQ TEST") {
      Object.keys(allQuestions).forEach(category => {
        ...
        error =
          "You must answer at least 50% of all question from each section";
        return;
      });
      return {
        valid,
                    ...
                    >
                      ...
                      <div className="col-xs-3 col-xs-offset-1 form-group">
                        <button
                          ...
                          id="singlebutton"
                          name="singlebutton"
                          className="btn btn-fill btn-info col-xs-12"
                        >
                          Save
                        </button>
                      </div>
                        ...
                        <div className="panel panel-default">
                          ...
                          >
                            ...
                            <div className="panel-body">
                              <div id="instructions">
                                {this.state.text[this.state.selectedCategory]}
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        >
                          <div className="panel-body">
                            <iframe
                              ...
                              height="350"
                              src={
                                this.state.videos[this.state.selectedCategory]
                              }
                              frameBorder="0"
                              allowFullScreen
                            />
