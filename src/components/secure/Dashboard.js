...
class Dashboard extends React.Component {
  ...
  render() {
    const { forms, isFound } = this.state;
        ...
        <div className="records col-xs-10">
          <div className="container card">
            ...
            <div className="header">
              <h4 className="title">Pending Reports</h4>
              <p className="category">
                Lists of Reports that are yet to be completed
              </p>
              {/*
            ...
            {isFound === "no" &&
              <h4 className="title text-center">No pending reports.</h4>}
            {isFound === "yes" &&
              pendingForm.length === 0 &&
              <h4 className="title text-center">No pending reports.</h4>}
          </div>
